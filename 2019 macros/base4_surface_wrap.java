...
public class base4_surface_wrap extends StarMacro {
  ...
  private void execute0() {
    ...
    //PartsOneGroupContactPreventionSet UT_SW = (PartsOneGroupContactPreventionSet) surfaceWrapOperation.getContactPreventionSet().getObject("SW UT contact prevention");
