...
public class base23_mesh_settings_save extends StarMacro {
  ...
  {
    new StarScript(getActiveRootObject(), new java.io.File(resolvePath("base23_mesh_settings.java"))).play();
